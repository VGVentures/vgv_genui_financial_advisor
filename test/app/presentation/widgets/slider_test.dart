import 'package:finance_app/app/presentation/widgets/slider.dart';
...
void main() {
  group(GcnSlider, () {
    group('basic variant', () {
      ...
      testWidgets('renders valueLabel in header', (tester) async {
        await tester.pumpApp(
          Scaffold(
            body: GcnSlider(
              title: 'Slider Title',
    ...
    group('splits variant', () {
      ...
      testWidgets('renders all split labels', (tester) async {
        await tester.pumpApp(
          Scaffold(
            body: GcnSlider(
              title: 'Slider Title',
