...
Use AppAccordion to group related action items under a collapsible header.
- title: A short, descriptive label for the group (e.g. "Debt Reduction Steps", "Savings Actions").
- items: List of action items to display when expanded. Each item has title, subtitle, amount, and optional delta, buttonLabel, buttonVariant.
- isExpanded: Set to true only when the content is urgent or the user explicitly asked for it. Defaults to false.
''';
  }
